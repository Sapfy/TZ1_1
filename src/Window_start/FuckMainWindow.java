...
import Other.Lang;
import Other.PasxEng;
import Other.WindowInfo;
...
public class FuckMainWindow extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FuckMainWindow frame = new FuckMainWindow();
...
//Вид переключателя	
		Image img2 = new ImageIcon(this.getClass().getResource("knop.png")).getImage();
		per.setIcon(new ImageIcon(img2));
...
//Stop/Start		
				textField = new JTextField("Stop/Start");
...
//Дейсвия при нажатии на кнопку.	         
	             new WindowInfo().setVisible(true);	           
	         }
		});
